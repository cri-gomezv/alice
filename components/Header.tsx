          ...
          <div className="hidden md:flex items-center space-x-6">
             {user ? (
                <>
                    ...
                    <button onClick={onLogout} className="text-gray-600 hover:text-indigo-600 transition-colors duration-300 font-medium">
                        Cerrar sesión
                    </button>
                </>
            ) : (
                <>
                    <button onClick={() => onNavigate('login')} className="text-gray-600 hover:text-indigo-600 transition-colors duration-300 font-medium">
                      Iniciar sesión
                    </button>
                    <a
                      href="#cta"
                      ...
                      className="bg-indigo-600 text-white font-semibold px-5 py-2 rounded-lg hover:bg-indigo-700 transition-all duration-300 transform hover:scale-105"
                    >
                      Comenzar
                    </a>
                </>
